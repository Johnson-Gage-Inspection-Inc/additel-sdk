...
def test_get_state_success(wlan_fixture: WLAN):
    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:STATe?"] = "1"
    assert wlan_fixture.get_state()

    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:STATe?"] = "0"
    assert not wlan_fixture.get_state()


def test_get_state_no_response(wlan_fixture: WLAN):
    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:STATe?"] = None
...
def test_get_ip_address_success(wlan_fixture: WLAN):
    ip_address = "192.168.1.100"
    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:ADDRess?"] = ip_address
    assert wlan_fixture.get_ip_address() == ip_address


def test_get_ip_address_no_response(wlan_fixture: WLAN):
    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:ADDRess?"] = None
...
def test_get_subnet_mask_success(wlan_fixture: WLAN):
    subnet_mask = "255.255.255.0"
    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:MASK?"] = subnet_mask
    assert wlan_fixture.get_subnet_mask() == subnet_mask


def test_get_subnet_mask_no_response(wlan_fixture: WLAN):
    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:MASK?"] = None
...
def test_get_gateway_success(wlan_fixture: WLAN):
    gateway = "192.168.1.1"
    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:GATEway?"] = gateway
    assert wlan_fixture.get_gateway() == gateway


def test_get_gateway_no_response(wlan_fixture: WLAN):
    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:GATEway?"] = None
...
def test_get_mac_success(wlan_fixture: WLAN):
    ...
    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:MAC?"] = mac_address
    assert wlan_fixture.get_mac() == mac_address


def test_get_mac_no_response(wlan_fixture: WLAN):
    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:MAC?"] = None
...
def test_get_dhcp_success(wlan_fixture: WLAN):
    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:DHCP?"] = "1"
    assert wlan_fixture.get_dhcp()

    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:DHCP?"] = "0"
    assert wlan_fixture.get_dhcp()


def test_get_dhcp_no_response(wlan_fixture: WLAN):
    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:DHCP?"] = None
...
def test_get_connection_success(wlan_fixture: WLAN):
    ...
    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:CONNect?"] = connection_status
    assert wlan_fixture.get_connection() == connection_status


def test_get_connection_no_response(wlan_fixture: WLAN):
    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:CONNect?"] = None
...
def test_get_dbm_success(wlan_fixture: WLAN):
    dbm_value = "-50 dBm"
    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:DBM?"] = dbm_value
    assert wlan_fixture.get_dbm() == dbm_value


def test_get_dbm_no_response(wlan_fixture: WLAN):
    wlan_fixture.parent.connection._responses["SYSTem:COMMunicate:SOCKet:WLAN:DBM?"] = None
