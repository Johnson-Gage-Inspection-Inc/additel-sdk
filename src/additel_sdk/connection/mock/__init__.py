...
class MockConnection(Connection):
    ...
    def __enter__(self):
        ...
        # Point this instance’s responses to the shared cache.
    ...
    def read_response(self) -> str:
        ...
        response = self.responses.get(self.last_command)
            ...
            try:
                ...
                with WLANConnection(self.parent, ip=self.ip) as wlan_connection:
                    ...
                    if response:  # Save only non-trivial responses
                        self.responses[self.last_command] = response
                        self.save_response(self.last_command, response)
